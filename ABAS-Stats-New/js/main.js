...
/* intrinsic values */
/* intrinsic values */
const _SECONDS_PER_ETH_BLOCK = 0.35;
...
//Times the ABAS in the contract * contractBal / totalBal
 ...
 el_safe('#TotalLiquidity').innerHTML = "<b>" + (totalPool1Num1).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 3}) + " </b> ABAS  and " + "<b>" + (totalPool1Num2).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 16}) + " </b> ETH  ";
