...
const _CONTRACT_ADDRESS = "0x027e2eB1C79bD1921a29fd377A8C978B3193401c"; //ABAS
const _CONTRACT_ADDRESS2 = "0xB742971FC521CB214981083fA1D6585712802f50"; //auction
const _CONTRACT_ADDRESS3 = "0xff5f7E17BB7d404026fA11C0261BA38E84739999"; //staking contract for LPers
const _CONTRACT_ADDRESS4 = "0xb7b592a96c4f5e52563e36458e45af32528c3d7b"; //LP token
...
//Times the ABAS in the contract * contractBal / totalBal
 ...
 el_safe('#Pool2TotalLiquidity').innerHTML = "<b>" + (totalPool2Num1).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 5}) + " </b> ABAS  and " + "<b>" + (totalPool2Num2).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 3}) + " </b> 0xBTC and <b>" + (totalPool2Num3).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 3}) + " </b> bForge  ";
  el_safe('#Pool2PercentOfLiquidityInStaking').innerHTML = "<b>" + (ratioStakedPool2*100).toLocaleString('en-US', {minimumFractionDigits: 0, maximumFractionDigits: 6}) + " </b> % ";
	...
	v2 = 10 ** 18 * totalPool2Num1 * totalPool1Num1 / totalPool1Num2
	dddd = totalPool2Num1 * totalContractLPTokens2 / totalCircLPTokens2 * 10 ** 18
...
// ffff / dddd = equation.  Get ffff now
  ...
  rewardRate1p2 = getValueFromStats('RewardRate Pool 2', stats)	
	ffff = rewardRate1p2 * (60*60*24*365)

  rewardRate3p2 = getValueFromStats('RewardRate3 Pool 2', stats)
	ffff2 = rewardRate3p2 * (60*60*24*365)
